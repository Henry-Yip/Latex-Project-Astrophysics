...
\maketitle
\begin{abstract}
This set of notes is made with reference to the Astrophysics Coursebook by The University of Edinburgh, written by Catherine Heymans and Andy Lawrence. I have gained permission from Professor Catherine Heymans to put my modified notes in my website.
\end{abstract}
\section{Definition}
\begin{itemize}
