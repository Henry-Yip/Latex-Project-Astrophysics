...
\begin{itemize}
\item $1pc=3.086 \times 10^{16}m$
\end{itemize}
\section{Binding energy}
\begin{itemize}
\item Gravitational energy of the shell:
\begin{equation}
    dU=\frac{-GM(<r)}{r}dm
\end{equation}
\item We also have:
\begin{align}
    M(<r)&=\rho \frac{4 \pi r^3}{3}\\
    \rho&=\frac{M_\text{tot}}{\frac{4}{3} \pi R^3}
\end{align}
\item Hence,
\begin{align}
    M(<r)&=\left(\frac{M_\text{tot}}{\frac{4}{3} \pi R^3} \right) \left(\frac{4 \pi r^3}{3} \right)\\
    &=\frac{M_\text{tot}r^3}{R^3}
\end{align}
\item Combining everything:
\begin{align}
     dU&=\frac{-GM(<r)}{r}dm\\
     \implies  dU&=\frac{-G\frac{M_\text{tot}r^3}{R^3}}{r}dm\\
     \implies  dU&=\frac{-GM_\text{tot}r^2}{R^3}dm
\end{align}
\item recall that $dm$=$\rho dV$ and $dV=4\pi r^2 dr$. Hence $dm= 4\pi r^2 \rho dr$
\end{itemize}
\item To be completed after exams!
